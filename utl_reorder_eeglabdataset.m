% EEG = utl_reorder_eeglabdataset(EEG, mode)
%
...
% 2018-02-22 lrk
%   - Removed inputParser because I needed this to work with R2013a for a
%     minute -_-
% 2017-08-02 First version

% This file **originally was** part of Simulating Event-Related EEG Activity (SEREEGA).
...
function EEG = utl_reorder_eeglabdataset(EEG, mode)
